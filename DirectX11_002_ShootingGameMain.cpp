#include "pch.h"
#include "DirectX11_002_ShootingGameMain.h"
...
DirectX11_002_ShootingGameMain::DirectX11_002_ShootingGameMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
DirectX11_002_ShootingGameMain::~DirectX11_002_ShootingGameMain()
{
	// 디바이스 알림 등록 취소
...
void DirectX11_002_ShootingGameMain::CreateWindowSizeDependentResources() 
{
	// TODO: 이 항목을 앱 콘텐츠의 크기 종속 초기화로 대체합니다.
	m_sceneRenderer->CreateWindowSizeDependentResources();
}

void DirectX11_002_ShootingGameMain::StartRenderLoop()
{
...
void DirectX11_002_ShootingGameMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// 프레임당 한 번 애플리케이션 상태를 업데이트합니다.
void DirectX11_002_ShootingGameMain::Update() 
{
	ProcessInput();
...
void DirectX11_002_ShootingGameMain::ProcessInput()
{
...
bool DirectX11_002_ShootingGameMain::Render() 
{
...
void DirectX11_002_ShootingGameMain::OnDeviceLost()
{
...
void DirectX11_002_ShootingGameMain::OnDeviceRestored()
{
